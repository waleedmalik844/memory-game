...
public class game6 : MonoBehaviour
{
    ...
    public int randomval, randomval1, randomval2, randomval3, randomval4, randomval5;
    ...
    public void rANDOMCOLOR()
    {
        ...
        randomval3 = Random.RandomRange(9, 12);
        randomval4 = Random.RandomRange(12, 15);
        randomval5 = Random.RandomRange(15, 17);
        ...
        imagearay[randomval4].color = Color.red;
        imagearay[randomval5].color = Color.red;
    ...
    public void btn_pres5(int e)
    {
        ...
        if (e == randomval4)
        {
            print(5);
            b5 = true;
            imagearay[randomval4].GetComponent<Button>().interactable = false;
        }
        else
        {
    ...
    public void btn_pres6(int f)
    {
        ...
        if (f == randomval5)
        {
            print(5);
            b6 = true;
            imagearay[randomval5].GetComponent<Button>().interactable = false;
        }
        else
        {
    ...
    public void reset()
    {
        ...
        imagearay[randomval4].color = Color.yellow;
        imagearay[randomval5].color = Color.yellow;
